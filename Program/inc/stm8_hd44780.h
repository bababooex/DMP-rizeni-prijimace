 ...
 *      Author: misa
 *  modded for 4x40 LCD by Adam Fucik
 */
...
#define LCD_COLUMNS 40 // 8 , 12 , 16 , 20 , 40 (not all are properly implemented)
...
#define LCD_E1_PIN  GPIO_PIN_6
#define LCD_E2_PIN  GPIO_PIN_5
...
#define LCD_E1_L   GPIO_WriteLow(LCD_E1_PORT, LCD_E1_PIN)
#define LCD_E1_H   GPIO_WriteHigh(LCD_E1_PORT, LCD_E1_PIN)
#define LCD_E2_L   GPIO_WriteLow(LCD_E2_PORT, LCD_E2_PIN)
#define LCD_E2_H   GPIO_WriteHigh(LCD_E2_PORT, LCD_E2_PIN)
